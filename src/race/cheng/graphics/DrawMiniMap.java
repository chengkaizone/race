	...
	private class Map {
		...
		public Map(float scale) {
			...
			{// 第一块路的纹理坐标
					...
					0.242f, 0, 0, 0.242f, 0.242f, 0.242f }, {// 第二块路的纹理坐标
					0.25f, 0, 0.25f, 0.242f, 0.492f, 0,

					0.492f, 0, 0.25f, 0.242f, 0.492f, 0.242f }, {// 第三块路的纹理坐标
					0.5f, 0, 0.5f, 0.242f, 0.742f, 0,

					0.742f, 0, 0.5f, 0.242f, 0.742f, 0.242f }, {// 第四块路的纹理坐标
					0.75f, 0, 0.75f, 0.242f, 1, 0,

					1, 0, 0.75f, 0.242f, 1, 0.242f }, {// 第五块路的纹理坐标
					0, 0.25f, 0, 0.5f, 0.242f, 0.25f,

					0.242f, 0.25f, 0, 0.5f, 0.242f, 0.5f }, {// 第六块路的纹理坐标
					0.25f, 0.25f, 0.25f, 0.5f, 0.5f, 0.25f,

					0.5f, 0.25f, 0.25f, 0.5f, 0.5f, 0.5f, }, {// 第七块路的纹理坐标
					0.5f, 0, 0.5f, 0.242f, 0.742f, 0,

					0.742f, 0, 0.5f, 0.242f, 0.742f, 0.242f }, {// 第八块路的纹理坐标
					0.75f, 0, 0.75f, 0.242f, 1, 0,

					1, 0, 0.75f, 0.242f, 1, 0.242f }, {// 第九块路的纹理坐标
					0, 0.25f, 0, 0.5f, 0.242f, 0.25f,

					0.242f, 0.25f, 0, 0.5f, 0.242f, 0.5f }, {// 第十块路的纹理坐标
					0.25f, 0.25f, 0.25f, 0.5f, 0.5f, 0.25f,
