 ...
 * 
 */
public class DrawSky extends Shape {
	Ball ball;
	...
	private class Ball {
		...
		public Ball(float scale, float radius) {
			...
			float angleV = 45;
			// 获取切分整图的纹理数组
			float[] texCoorArray = generateTexCoor((int) (360 / ANGLE_SPAN), // 纹理图切分的列数
			...
			for (float vAngle = angleV + 5; vAngle > 5; vAngle = vAngle
					- ANGLE_SPAN)// 垂直方向angleSpan度一份
			{
