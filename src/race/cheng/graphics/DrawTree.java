...
public class DrawTree extends Shape {
	...
	public void calculateDirection(float xOffset, float zOffset, float cx,
			float cz) {// 根据摄像机位置计算树朝向
	...
	private class Tree {
		...
		public Tree(float scale) {
			...
			{// 第一个树的纹理坐标
					0, 0, 0, 0.7343f, 0.1484f, 0,

					0.1484f, 0, 0, 0.7343f, 0.1484f, 0.7343f }, {// 第二棵树的纹理坐标
					0.1484f, 0, 0.1484f, 0.7343f, 0.2968f, 0,

					0.2968f, 0, 0.1484f, 0.7343f, 0.2968f, 0.7343f }, {// 第三棵树的纹理坐标
					0.2972f, 0, 0.2972f, 0.7343f, 0.4453f, 0,

					0.4453f, 0, 0.2972f, 0.7343f, 0.4453f, 0.7343f }, {// 第四棵树的纹理坐标
					0.4453f, 0, 0.4453f, 0.7343f, 0.5933f, 0,

					0.5933f, 0, 0.4453f, 0.7343f, 0.5933f, 0.7343f }, {// 第五棵树的纹理坐标
					0.5937f, 0, 0.5937f, 0.7343f, 0.7422f, 0,

					0.7422f, 0, 0.5937f, 0.7343f, 0.7422f, 0.7343f }, {// 第六棵树的纹理坐标
					0.7424f, 0, 0.7424f, 0.7343f, 0.8906f, 0,

					0.8906f, 0, 0.7424f, 0.7343f, 0.8906f, 0.7343f, } };
