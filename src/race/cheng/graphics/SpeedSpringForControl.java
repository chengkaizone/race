...
import static race.cheng.service.Constant.JJSTHBJ;
import static race.cheng.service.Constant.X_SPAN;
import static race.cheng.view.MyGLSurfaceView.SpeedFactor;
import static race.cheng.view.MyGLSurfaceView.SpeedFactorControl;
import static race.cheng.view.MyGLSurfaceView.carV;
import static race.cheng.view.MyGLSurfaceView.lovn_speed_spring;
...
public class SpeedSpringForControl {
	...
	public SpeedSpringForControl(int id, float x, float y, float z, int row,
			int col) {
		this.id = id;
		this.x = x;
		this.y = y;
